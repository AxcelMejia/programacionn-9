...
/* Observa que las dos instrucciones del programa 9.1 necesarias para abrir un archivo y verificar que éste en realidad se haya abierto, se pueden agrupar
