...
/* Alumnos.
El programa lee bloques —variables de tipo eessttrruuccttuurraa aalluummnnoo— de un archivo de acceso directo. */
...
➥instrucciones ffwwrriittee yy ffrreeaadd es
moverse y leer o escribir, según sea el caso.
